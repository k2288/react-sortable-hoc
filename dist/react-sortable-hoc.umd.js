    ...
    _createClass(AutoScroller, [
      ...
      },
      {
        ...
        value: function update(_ref) {
          ...
          var isLeft = scrollLeft === (!rtl ? 0 : clientWidth - scrollWidth);
          var isRight = scrollLeft === (!rtl ? scrollWidth - clientWidth : 0);
      ...
      (_temp = _class = (function(_React$Component) {
        ...
        function WithSortableContainer(props) {
          ...
          _defineProperty(
            ...
            'keyMove',
            function(shift) {
              if (_this.props.rtl && _this.props.axis.indexOf('x') !== -1) {
                shift = -1 * shift;
              }
                ...
                if (this.axis.x) {
                  if (this.axis.y) {
                    if (
                      ...
                      translate.x =
                        translateXFactor * (this.width + this.marginOffset.x);
